# 디렉토리 A와 B의 경로 설정
$directoryA = "D:\work\lecture\Lecture_EOPL\hw\hw_ch3_letrec"
$directoryB = "D:\work\lecture\Lecture_EOPL_Exercise\ch3\app\letreclang"
$directoryC = "D:\work\lecture\Lecture_EOPL_Exercise\ch3"
...
foreach ($file in $files) {
    ...
    # stack test ch3:test:letreclang-test 실행
    # stack clean
    stack test ch3:test:letreclang-test
