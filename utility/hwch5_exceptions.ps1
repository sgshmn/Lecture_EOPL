# 디렉토리 A와 B의 경로 설정
$directoryA = "D:\work\lecture\Lecture_EOPL\hw\hw_ch5_exceptions"
$directoryB = "D:\work\lecture\Lecture_EOPL_Exercise\ch5\app\exceptions"
...
foreach ($file in $files) {
    ...
    # stack test ch5:test:exceptions-test 실행
    stack clean
