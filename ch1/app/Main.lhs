...
> in_S :: Int -> Bool
> in_S n = if n == 0 then True
>          else if n - 3 >= 0 then in_S (n-3)
>          else False
...
> nth_element :: [a] -> Int -> a
> nth_element []     n = report_list_too_short n
> nth_element (x:xs) 0 = x
> nth_element (x:xs) n = nth_element xs (n-1)
>
...
> partial_array_sum arr 0 = arr ! 0                               
> partial_array_sum arr n = arr ! n + partial_array_sum arr (n-1)
>
